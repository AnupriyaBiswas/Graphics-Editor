...
class GraphicsEditor:
    ...
    def init_ui(self):
        ...
        self.zoom_slider = tk.Scale(toolbar, from_=20, to=500, orient=tk.HORIZONTAL, showvalue=0, command=self.update_zoom)
    ...
    def zoom_in(self):
        if self.zoom_level < 5.0:  # Limit zoom in
            self.zoom_level *= 1.2
            self.zoom_slider.set(self.zoom_level * 100)  # Update slider value
            self.apply_zoom()
